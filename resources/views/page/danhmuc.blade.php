					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">{{$tenhang->ma_hang}}</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
						<div class="results">Có <span>{{count($getsp)}}</span> kết quả</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						@foreach($getsp as $sp)
							<div class="product"><a href="{{route('chitietsanpham',$sp->id)}}">
								<div class="product_image"><img src="sublime/images/dt/{{$sp->anh}}" alt=""></div>
								@if($sp->new ==1)
								<div class="product_extra product_new"><a href="categories.html">New</a></div>@endif
