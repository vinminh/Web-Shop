      ...
      <div class="main">
         <div class="col-md-6 col-sm-12">
            <div class="login-form">
               <form action="{{URL::to('/postlogin')}}" method="post">{{csrf_field()}}
                  ...
                  <a class="btn btn-secondary" href="{{URL::to('/register')}}">Đăng ký</a> 
                  <a class="btn btn-secondary" href="{{URL::to('/resetpw')}}">Quên Mật Khẩu</a>
               </form>
            </div>
         </div>
      </div>
