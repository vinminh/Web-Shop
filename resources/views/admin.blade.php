            ...
            <div class="container-fluid">
                <div class="header-mobile-inner">
                    <a class="logo" href="{{URL::to('/dashboard')}}">
                        <img src="{{asset('backend/images/icon/logo.png')}}" alt="Alo" />
                    </a>
        ...
        <div class="menu-sidebar__content js-scrollbar1">
            <nav class="navbar-sidebar">
                <ul class="list-unstyled navbar__list">
                    ...
                    <li class="has-sub">
                        <a class="js-arrow" href="{{URL::to('/danh-sach-hang-san-xuat')}}">
                        <i class="fas fa-desktop"></i>Quản lý loại hàng</a>
                    </li>
                   <!--  <li class="has-sub">
                        <a class="js-arrow" href="{{URL::to('/danh-sach-loai-san-pham')}}">
                            <i class="fas fa-th"></i>Quản lý loại sản phẩm</a>
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                        </ul>
                    </li> -->
                    <li class="has-sub">
                        <a class="js-arrow" href="{{URL::to('/danh-sach-san-pham')}}">
                    ...
                    <li>
                        <a href="{{URL::to('/danh-sach-user')}}">
                            <i class="fas fa-calendar-alt"></i>Quản lý user</a>
                    </li>                    
                </ul>
            </nav>
        </div>
